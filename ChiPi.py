...
async def on_message(message):
    if message.author.bot:
        return None
    if message.content == "치피야 명령어":
        await message.channel.send("특수문자랑 띄어쓰기를 넣어서 질문하시면 제가 못 알아봐요!")
    if message.content.startswith("치피야 안녕"):
        await message.channel.send("안녕하세요!")
    if message.content.startswith("치피야 누구꺼"):
        await message.channel.send("**백여우님**꺼요..!")
    ...
    if message.content.startswith("치피야 목디"):
    ...
    if message.content.startswith("치피야 쿠코"):
    ...
    if message.content.startswith("치피야 샌즈"):
        await message.channel.send("파피루스!")
    ...
    if message.content == "치피야 여우":
        await message.channel.send("is Genius")
    if message.content.startswith("치피야 백여우"):
        await message.channel.send("is Genius")
    if message.content.startswith("치피야 고추절단기"):
        await message.channel.send("앗...아..")
    if message.content.startswith("치피야 샤인"):
        await message.channel.send("으웩")
    if message.content.startswith("치피야 핑킹가위"):
        await message.channel.send("썪뚞!")
    if message.content == "치피야 루미에":
        await message.channel.send("그거 샤인이죠? 으웩")
    ...
    if message.content == "치피야 밥줘":
        await message.channel.send("[밥하러감]")
    ...
    if message.content.startswith("치피야") and message.author.id != 704319250155700224:
        ...
        sheet = file.active
        exp = [50, 100, 200, 400, 800, 1000, 3000, 5000, 7500, 10000]
        i = 1
        while True:
